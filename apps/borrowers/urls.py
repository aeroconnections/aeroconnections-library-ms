...
urlpatterns = [
    path(
        "",
        RedirectView.as_view(url="/borrowers/?status=active", permanent=False),
        name="borrower_list",
    ),
    ...
    path(
        "import/confirm/", views.borrower_import_confirm, name="borrower_import_confirm"
    ),
    ...
    path("<int:pk>/delete/", views.borrower_delete, name="borrower_delete"),
]
